...
public class HW2Tester {
	...
	private static TestCase testCases[] = {
		...
		new TestCase("setNibble", 0x0001, 0x0000, 0x1, 0,
		                          0xFFF0, 0xFFFF, 0x0, 0,
		                          0xFF6F, 0xFFFF, 0x6, 1,
		                          0x13E2, 0x1312, 0xE, 1,
		                          0x0800, 0x0000, 0x8, 2,
		...
		new TestCase("getShort", 0x0202, 0x10100202, 0,
		                         0xBEEF, 0xDEADBEEF, 0,
		                         0xDEAD, 0xDEADBEEF, 1,
		                         0x1234, 0x12345678, 1),
		                            
		new TestCase("pack", 0x1234, 0x1, 0x2, 0x3, 0x4,
		                     0xBEEF, 0xB, 0xE, 0xE, 0xF,
		                     0xCAFE, 0xC, 0xA, 0xF, 0xE,
		                     0xAAAA, 0xA, 0xA, 0xA, 0xA),
	 ...
	 * @param t A TestCase whose data will be used in this test.
	 */
	private static void test_setNibble(TestCase t) {
		...
		for(int i = 0; i < t.tests.length; i += 4) {
			...
			int res = HW2Operations.setNibble(arg1, arg2, arg3);
			boolean cor = exp == res;
			if(cor) {
				++score;
			}
	 ...
	 * @param t A TestCase whose data will be used in this test.
	 */
	private static void test_getShort(TestCase t) {
		...
		for(int i = 0; i < t.tests.length; i += 3) {
			...
			int arg1 = (Integer) t.tests[i + 1];
			int arg2 = (Integer) t.tests[i + 2];
			int res = HW2Operations.getShort(arg1, arg2);
			boolean cor = exp == res;
			if(cor) {
				++score;
			}
